 ...
 * @author hasil
 */
public class view_student extends javax.swing.JDialog {

    /**
     * Creates new form view_student
     */
    public view_student(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        String colHeader []= new String []{"ID","First Name","Last Name","Phone No.","Address","Faculty","Course","Semester"
 ...
 db_operation1 dbopt=new db_operation1();
          String a= table.getModel().getValueAt(table.getSelectedRow(), 0).toString();
         // this.setVisible();
           new updatestudent(a);         // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                view_student dialog = new view_student(new javax.swing.JFrame(), true);
